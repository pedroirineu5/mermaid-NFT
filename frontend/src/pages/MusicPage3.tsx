    ...
    <>
      ...
      <div className="w-screen h-screen bg-[#1B2B40] flex flex-col items-center justify-between ">
        ...
        <div className="rounded-3xl w-[60vw] h-[60vh] bg-slate-700 flex flex-row items justify-between">
          <img className="rounded-l-3xl basis-1/2" src="luanSantana.png" alt="Smooth Criminal" />

          <div className="basis-1/2 flex flex-col items-center justify-center space-y-4">
            <span className="text-5xl text-bold text-[#fff]">Meio termo</span>
            <span className="text-xl text-[#fff]"><span className="font-extrabold">Artista:</span> Luan Santana</span>
            <span className="text-xl text-[#fff]"><span className="font-extrabold">Produtores:</span> Bia Frazzo e cia.</span>
            <span className="text-xl text-[#fff]"><span className="font-extrabold">Gravadora:</span> Sony Music Entertainment Brasil </span>
          </div>
        </div>
