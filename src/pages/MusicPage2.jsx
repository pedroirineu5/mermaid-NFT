      ...
      <div class="w-screen h-screen bg-[#1B2B40] flex flex-col items-center justify-between ">
        <header class="flex flex-row justify-between p-8 bg-[#00060D] w-screen h-[90px]">
          ...
          <div class="rounded-3xl w-[60vw] h-[60vh] bg-slate-700 flex flex-row items justify-between">
              <img class=" rounded-l-3xl basis-1/2"src="coldplay.jpg" alt="Smooth Criminal" />

              <div class="basis-1/2 flex flex-col items-center justify-center space-y-4">
                <span class="text-5xl text-bold text-[#fff]">Yellow</span>
                <span class="text-xl text-[#fff]"><span class="font-extrabold">Autor:</span> Coldplay</span>
                <span class="text-xl text-[#fff]"><span class="font-extrabold">Produtores:</span> Coldplay</span>
                <span class="text-xl text-[#fff]"><span class="font-extrabold">Gravadora:</span> Nettwerk</span>
              </div>
          </div>
